...
bash
# Clone repository
git clone :  https://github.com/aayushisabharwal/techlearn-backend-qotd.git
cd qotd-backend
...
👤 Author
Aayushi Sabharwal - Backend Developer Candidate

GitHub: aayushisabharwal

Repository: https://github.com/aayushisabharwal/techlearn-backend-qotd/
