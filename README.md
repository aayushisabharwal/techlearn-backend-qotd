...
🚀 Live Deployment
Base URL: [https://qotd-backend.onrender.com](https://qotd-backend.onrender.com)
...
git clone [https://github.com/yourusername/qotd-backend.git](https://github.com/yourusername/qotd-backend.git)
cd qotd-backend
...
curl [http://localhost:3000/api/health](http://localhost:3000/api/health)

# Today's question

curl [http://localhost:3000/api/questions/today](http://localhost:3000/api/questions/today)

# Submit a solution

curl -X POST [http://localhost:3000/api/submissions](http://localhost:3000/api/submissions) 
